...
function page8_06() {
  ...
  return (
    ...
    <div className={styles.main}>
      ...
      <p> "state"：  這是一個 JavaScript 物件，可以包含與路由相關的自訂資訊。通常用於保存一些臨時狀態或資訊，藉由路徑跳轉時傳遞。</p><hr/>
      <p> "pathname"： 當前頁面路徑 </p>
      <hr/><br/>
      <h2>路由跳轉到：</h2>
      <button onClick={handleNavigate}>跳轉 Page8_07的頁面 "並傳遞state狀態"</button>
      <div>
      <hr/><br/>
      <hr/><br/>
      <hr/><br/>
